...
// only one "extend" but as many "implements" as  I want
class Dog2
...
// it needs statically members (so e.g. number is not an option) -> CanBart2 type for example contains number
...
// everywhere the AnimalLike interface is used, it will now also have the isAlive method
// it's only available to interfaces, types cannot be augmented like this
